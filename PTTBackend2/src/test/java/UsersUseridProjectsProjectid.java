...
public class UsersUseridProjectsProjectid {
    ...
    public void pttTest4() throws Exception {
        ...
        try {
            ...
            response = postUsersUseridProjects("1", "test", "1");
    ...
    public void pttTest5() throws Exception {
        ...
        try {
            CloseableHttpResponse response = postUsers("abc@def.com", "Way", "1", "Toshiba");
            response = postUsersUseridProjects("1", "test", "1");
            response = getUsersUseridProjectsProjectid("1", "10");
    ...
    public void pttTest6() throws Exception {
        ...
        try {
            CloseableHttpResponse response = postUsers("abc@def.com", "Way", "1", "Toshiba");
            response = postUsersUseridProjects("1", "test", "1");
            response = getUsersUseridProjectsProjectid("1", "1");
            ...
            String expectedJson = "[{\"id\":\"1\",\"projectname\":\"test\",\"userId\":\"1\"}]";
    ...
    public void pttTest7() throws Exception {
        ...
        try {
            CloseableHttpResponse response = postUsers("abc@def.com", "Way", "1", "Toshiba");
            response = postUsersUseridProjects("1", "test", "1");
            response = deleteUsersUseridProjectsProjectid("1", "1");
