...
public class UsersUserIdProjectsProjectIdSessionsSessionIdTests {
    ...
    @Test
    // Purpose: the server should return 400 or 404 for user with non-numeric user id
    ...
    @Test
    // Purpose: the server should return 400 for session with an empty start time, we require the request to contain both start time and end time.
    public void pttTest3() throws IOException {
    ...
    @Test
    // Purpose: the server should return 400 for session without an end time. We require the request to contain both a start time and an end time.
    ...
    @Test
    // Purpose: the server should return 400 for a session with negative counter
    ...
    @Test
    // Purpose: the server should return 200 and the correct json object for a valid session with counter == 0 where end time hours - start time hours = 2 * counter
