...
public class PTTUsers {
    ...
    // Purpose: Post + test if email is null
    @Test
    public void pptTest1() throws Exception {
	    deleteUsers();
        deleteProjects();
        try {
            CloseableHttpResponse response =
		createUser("John", "Doe", null);
            ...
            String expectedJson = "{\"id\":" + id + ",\"firstName\":\"John\",\"lastName\":\"Doe\",\"email\":\"null\"}";
    ...
    // Purpose: Post + test if email is valid
    @Test
    ...
    // Purpose: Post + test if email is registered before
    @Test
    public void pptTest3() throws Exception {
	    deleteUsers();
        deleteProjects();
        try {
            CloseableHttpResponse response = 
    ...
    // Purpose: Post + test if first name is null
    @Test
    ...
    // Purpose: Post + test if last name is null
    @Test
    public void pttTest5() throws Exception {
	    deleteUsers();
        try {
            CloseableHttpResponse response = 
                createUser("John", null , "john@doe.org");
            int status = response.getStatusLine().getStatusCode();
            HttpEntity entity;
            if (status == 201) {
                entity = response.getEntity();
            ...
            String expectedJson = "{\"id\":" + id + ",\"firstName\":\"John\",\"lastName\":\"null\",\"email\":\"john@doe.org\"}";
	    JSONAssert.assertEquals(expectedJson,strResponse, false);
            EntityUtils.consume(response.getEntity());
            response.close();
        } finally {
    ...
    // Purpose: Post + test if user can be created
    @Test
    ...
    // Purpose: Post + test if we can retrive all users
    @Test
