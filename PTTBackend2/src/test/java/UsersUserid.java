...
public class UsersUserid {
    ...
    public void pttTest6() throws Exception {
        ...
        try {
            ...
            String expectedJson = "{\"email\":\"abc@def.com\",\"firstName\":\"Way\",\"id\":\"1\",\"lastName\":\"Toshiba\"}";
    ...
    public void pttTest7() throws Exception {
        ...
        try {
            ...
            response = putUsersUserid("abc@def.com", "Road", "1", "Toshiba");
            ...
            String expectedJson = "[{\"email\":\"abc@def.com\",\"firstName\":\"Road\",\"id\":\"1\",\"lastName\":\"Toshiba\"}]";
            JSONAssert.assertEquals(expectedJson,strResponse, false);
            EntityUtils.consume(response.getEntity());
            response.close();
        } finally {
